...
/***/ function(module, exports, __webpack_require__) {
	...
	var Audience = __webpack_require__(254);
	var Board = __webpack_require__(257);
	var Whoops = __webpack_require__(258);

	var routes = React.createElement(
	  Route,
	  { handler: Main },
	  React.createElement(DefaultRoute, { name: 'home', handler: Audience }),
	  ...
	  React.createElement(NotFoundRoute, { handler: Whoops })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Display = __webpack_require__(249);
	var JoinSpeaker = __webpack_require__(251);
	var Attendance = __webpack_require__(252);
	...
	var JoinSpeaker = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { ref: 'name', className: 'form-control', placeholder: 'enter your full name...', required: true }),
	      React.createElement(
	        'label',
	        null,
	        'Presentation Title'
	      ),
	      React.createElement('input', { ref: 'title', className: 'form-control', placeholder: 'enter a title for this presentation', required: true }),
	      React.createElement(
	        'button',
